...
<body>
	...
	<h3 style="color: red;">Show All Directors</h3>
	<table id ="t01" style = 'width:80%'>
		<tr><th>Name</th> <th>DoB</th> <th>Nationality</th>
		<th>Gender</th> <th>WikiLink</th> </tr>
		<c:forEach var="listValue" items="${directors}">
			<tr></td> <td>${listValue.getDirectorName()}</td>
			<td>${listValue.getDob()}</td> <td>${listValue.getDirectorNationality()}</td>
